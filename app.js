...
const stages = {
    1: {
        ...
        hint: "💡 Код состоит из слова, описывающего происходящее на ферме, и года через нижнее подчеркивание",
        fact: "🐔 Интересный факт: Куры могут запомнить до 100 разных лиц!",
        answer: "ЗАРАЖЕНИЕ_2025",
        points: 100,
        difficulty: "easy",
        timeBonus: 50
    },
    2: {
        ...
        hint: "💡 Символы нужно ввести в том порядке, в котором они расположены от входа",
    ...
    3: {
        ...
        hint: "💡 Пароль связан с их ролью на ферме",
        fact: "🦢 Гуси могут летать на высоте до 8 км и спать во время полета!",
    ...
    4: {
        title: "🦙 ЭТАП 4: МУДРАЯ АЛЬПАКА",
        description: "Альпака на ферме кажется единственным животным, сохранившим рассудок. Она наблюдает за происходящим и знает секрет антидота, но общается только с помощью специальных символов.",
        task: "🔡 Расшифруйте сообщение альпаки по последовательности символов",
        hint: "💡 Альпака показывает символы в определенной последовательности",
        fact: "🦙 Альпаки могут быть разных цветов - от белого до черного, всего 22 естественных оттенка!",
        answer: "АЛЬПАКА2025",
        points: 250,
        difficulty: "hard",
        timeBonus: 125
    ...
    5: {
        title: "🐕 ЭТАП 5: БЫСТРЫЕ БОРЗЫЕ",
        description: "Борзые собаки, известные своей скоростью, носят на ошейниках части кода. Они бегают так быстро, что вам нужно определить правильную последовательность цифр по их номерам.",
        task: "🎯 Определите правильную последовательность цифр по номерам на ошейниках борзых",
        hint: "💡 Собаки с номерами 3, 1, 4, 2 пересекают финиш в определенном порядке",
        fact: "🐕 Борзые могут развивать скорость до 70 км/ч и являются одной из самых быстрых пород собак!",
        answer: "3142",
        points: 300,
        difficulty: "medium",
        timeBonus: 150
    ...
    6: {
        ...
        hint: "💡 Обратите внимание на природное явление, которое имеет семь цветов",
    ...
    8: {
        ...
        hint: "💡 Пароль - дата начала эксперимента в определенном формате",
    ...
    9: {
        ...
        hint: "💡 Собирайте пазл от углов, обращайте внимание на цветные метки",
    ...
    11: {
        ...
        hint: "💡 Следуйте формуле смешивания цветов",
...
function updateGameUI() {
    ...
    document.getElementById('hint-btn').disabled = (gameState.hintsUsed >= CONFIG.MAX_HINTS);
    document.getElementById('skip-btn').disabled = (gameState.skipsUsed >= CONFIG.MAX_SKIPS);
}
...
function setupEventListeners() {
    ...
    document.getElementById('leaderboard')?.addEventListener('click', () => {
        showNotification('🏆 Таблица лидеров скоро будет доступна!', 'info');
    });
    document.getElementById('achievements')?.addEventListener('click', () => {
        showNotification('🎯 Ваши достижения скоро будут доступны!', 'info');
    });
